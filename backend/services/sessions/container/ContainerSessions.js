...
import { filterUserPromptContextFromEntry, filterProjectPromptFromEntry } from '../../core/utils/jsonl-parser.js';
...
export { listSessionFiles, getProjectDir, sessionExistsInProject, sessionHasDirectEntries } from './sessionReader.js';
...
function _sortAndFilterMessages(messages) {
  ...
  // 过滤所有用户消息中的用户提示词与项目提示词上下文
  return messages.map(filterUserPromptContextFromEntry).map(filterProjectPromptFromEntry);
}
