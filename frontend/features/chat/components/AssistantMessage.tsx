  ...
  return (
    <div className="prose prose-sm dark:prose-invert max-w-none">
      ...
      {showThinking && thinking && (
        <details className="mb-4 group/thinking border border-border/50 rounded-lg overflow-hidden bg-muted/30">
          <summary className="flex items-center gap-2 cursor-pointer px-4 py-2.5 hover:bg-accent/50 transition-colors">
            <svg className="w-4 h-4 text-muted-foreground transition-transform duration-200 group-open/thinking:rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
