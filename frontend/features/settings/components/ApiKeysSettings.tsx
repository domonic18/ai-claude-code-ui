...
function ApiKeysSettings() {
  ...
  const deleteGithubToken = async (tokenId) => {
    if (!confirm(t('apiKeys.confirmDeleteToken'))) return;
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-4">
          {t('apiKeys.githubTokensDescription')}
        </p>
        ...
        {showNewTokenForm && (
          <div className="mb-4 p-4 border rounded-lg bg-card">
            ...
            <div className="flex gap-2">
              <Button onClick={createGithubToken}>{t('apiKeys.addToken')}</Button>
      ...
      <div className="p-4 bg-muted/50 rounded-lg">
        ...
        <p className="text-sm text-muted-foreground mb-3">
          {t('apiKeys.externalApiDescription')}
        </p>
        <a
